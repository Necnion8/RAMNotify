...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Sun Feb 18 23:35:03 2024
#
...
class ProcessListPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.btn_kill = wx.Button(self, wx.ID_ANY, u"強制終了")
        ...
        self.Bind(wx.EVT_BUTTON, self.on_button, self.btn_kill)
    ...
    def __do_layout(self):
        ...
        sizer_footer.Add(self.btn_kill, 0, 0, 0)
