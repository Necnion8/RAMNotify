...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.4 on Fri Jun 12 16:11:14 2020
#
...
class RamNotifyPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.choice_refresh_rate = wx.Choice(self, wx.ID_ANY, choices=[u"0.5秒", u"1秒", u"5秒", u"10秒", u"30秒", u"1分", u"5分"])
    ...
    def __do_layout(self):
        ...
        sizer_content.Add(sizer_refresh_rate, 0, wx.EXPAND, 0)
        sizer_content.Add((0, 6), 0, 0, 0)
        ...
        sizer_content.Add(sizer_task_bar_icon, 0, wx.EXPAND, 0)
        sizer.Add(sizer_content, 1, wx.EXPAND | wx.LEFT | wx.RIGHT, 12)
        sizer.Add((0, 0), 0, wx.TOP, 6)
